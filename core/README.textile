...
1. *In-memory*. For periodic, @ArrayDeque@ of @LinkedHashMap@ / @TreeMap@ is
   probably a good choice. If you need to store point time, use @LinkedHashMap@ of
   @LinkedHashMap@ / @TreeMap@, where the first map is keyed by time.
